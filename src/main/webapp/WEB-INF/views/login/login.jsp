						...
						<div class="page-login-form box">
							...
							<form class="login-form" method="post" action="/actionLogin">
								<div class="form-group">
									<div class="form-group">
										...
										<input type="checkbox" name="userType" value="true"
											onclick="toggleKakaoLoginButton()"> 중개사무소 로그인
									</div>
								...
								<div class="form-group">
									<div class="input-icon">
										<i class="lni-lock"></i> <input type="password"
											class="form-control" name="userPw" placeholder="비밀번호를 입력하세요">
									</div>
								</div>
							...
							<script>
								...
								function toggleKakaoLoginButton() {
									var checkbox = document
											.querySelector('input[name="userType"]');
									var kakaoLoginButton = document
							...
							<div class="btn-cont" style="text-align: center;">
								...
								<a class="btn-kakao" id="kakao-login-btn" href="#"
									...
									src="../resources/comm/kakao_login_medium_wide.png"
															...
															.request({
																...
																success : function(
																	...
																	console
																			.log(response)
																	$(
																			"#joinFrm input[name=userId]")
																			.val(
																					response.id);
																	$(
																			"#joinFrm input[name=userName]")
																			.val(
					...
					function requestUserInfo() {
					  ...
					  function getCookie(name) {
					    ...
					    if (parts.length === 2) { return parts[1].split(';')[0]; }
							...
							<hr>
							<ul class="form-links">
								<li class="text-center">아직 회원이 아니신가요?&nbsp;&nbsp; <a
									href="/user/add"> 회원 가입하기 </a></li>
							</ul>
						</div>
					</div>
				</div>
