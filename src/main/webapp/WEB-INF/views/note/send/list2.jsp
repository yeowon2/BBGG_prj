                                            ...
                                            <c:forEach var="noteVO" items="${sendList}">
                                                <div>
                                                    <a href="javascript:void(0);" class="media" data-note-no="${noteVO.noteNo}">
                                                        ...
                                                        <div class="media-body">
                                                            <div>
                                                                <div data-note-no="${noteVO.noteNo}" data-user-no="${noteVO.userNo}"></div>
                                                                <div class="email-head font-weight-700 font-lg-15" id="compName">${noteVO.compName}</div>
                                        ...
                                        <div class="nicescroll-bar">
                                            <div>
                                                <div class="email-subject-head  ml-50">
                                                    <h5 class="font-weight-700 font-lg-16" id="comp-name"><!-- 폴리 공인중개사무소 --></h5>
                                                </div>
                                                ...
                                                <div class="email-head">
                                                    ...
                                                    <div class="head-other-wrap mr-50">
                                                        <div class="d-inline-block">
                                                            <span class="d-inline-block" id="regist-date">2023/09/22 10:42</span>
                                                        </div>
                                                ...
                                                <div class="email-text-wrap ml-50 mr-50 mt-30">
                                                    ...
                                                    <div id="note-content"  class="mt-30 " >
        ...
        element.addEventListener('click', function () {
            ...
            fetch(ajaxUrl)
                ...
                .then(function (noteVO) {
                    ...
                    document.querySelector('#comp-name').textContent = compName;
