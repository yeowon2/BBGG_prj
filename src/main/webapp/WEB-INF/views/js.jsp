<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <script src="/resources/assets/js/jquery.mixitup.js"></script>
    <script src="/resources/assets/js/jquery.counterup.min.js"></script>
    <script src="/resources/assets/js/ion.rangeSlider.js"></script>
    ...
    <script src="/resources/assets/js/nivo-lightbox.js"></script>
    <script src="/resources/assets/js/jquery.slicknav.js"></script>
    <script src="/resources/assets/js/main.js"></script>
    <script src="/resources/assets/js/form-validator.min.js"></script>
    <script src="/resources/assets/js/contact-form-script.min.js"></script>
