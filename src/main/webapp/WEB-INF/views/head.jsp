<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <!-- Required meta tags -->
	...
	<link rel="apple-touch-icon" sizes="72x72" href="/resources/comm/favicon/apple-icon-72x72.png">
	<link rel="apple-touch-icon" sizes="76x76" href="/resources/comm/favicon/apple-icon-76x76.png">
	<link rel="apple-touch-icon" sizes="114x114" href="/resources/comm/favicon/apple-icon-114x114.png">
	<link rel="apple-touch-icon" sizes="120x120" href="/resources/comm/favicon/apple-icon-120x120.png">
	<link rel="apple-touch-icon" sizes="144x144" href="/resources/comm/favicon/apple-icon-144x144.png">
	...
	<meta name="msapplication-TileImage" content="/resources/comm/favicon/ms-icon-144x144.png">
    ...
    <!-- Range Slider -->
    <link rel="stylesheet" type="text/css" href="/resources/assets/css/ion.rangeSlider.css">
    <!-- Range Slider  -->
    <link rel="stylesheet" type="text/css" href="/resources/assets/css/ion.rangeSlider.skinFlat.css">
    <!-- Nivo Lightbox -->
    <link rel="stylesheet" type="text/css" href="/resources/assets/css/nivo-lightbox.css" >
    <!-- Animate -->
